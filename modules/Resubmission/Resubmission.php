...
class Resubmission extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_resubmission';
	var $table_index= 'resubmissionid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_resubmissioncf', 'resubmissionid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_resubmission', 'vtiger_resubmissioncf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_resubmission' => 'resubmissionid',
		'vtiger_resubmissioncf'=>'resubmissionid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = Array (
		'LBL_RELATED_TO' => array('resubmission', 'related_to'),
		'LBL_RESUBMITTED_DATE' => array('resubmission', 'resubmitted_date'),
		'LBL_DATE' => array('resubmission', 'date'),

	);
	var $list_fields_name = Array (
		'LBL_RELATED_TO' => 'related_to',
		'LBL_RESUBMITTED_DATE' => 'resubmitted_date',
		'LBL_DATE' => 'date',

	);

	// Make the field link to detail view
	var $list_link_field = 'resubmission_no';
	...
	var $popup_fields = Array ('resubmission_no');

	// For Alphabetical search
	var $def_basicsearch_col = 'resubmission_no';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'resubmission_no';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('resubmission_no','assigned_user_id');

	var $default_order_by = 'resubmission_no';
	var $default_sort_order='ASC';

	function Resubmission() {
		$this->log =LoggerManager::getLogger('Resubmission');
		$this->db = PearDatabase::getInstance();
		$this->column_fields = getColumnFields('Resubmission');
	}
