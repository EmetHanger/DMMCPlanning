...
$fieldInstance = Vtiger_Field::getInstance("LBL_PLAN_STATUS", $moduleInstance);
        if ($fieldInstance === false) {
$fieldInstance = new Vtiger_Field();
$fieldInstance->name = 'plan_status';
$fieldInstance->label = 'LBL_PLAN_STATUS';
$fieldInstance->table = 'vtiger_blockplan';
$fieldInstance->column = 'plan_status';
...
$fieldInstance = Vtiger_Field::getInstance("LBL_ASSAIGNED_DRAUGHTSMAN", $moduleInstance);
        if ($fieldInstance === false) {
$fieldInstance = new Vtiger_Field();
$fieldInstance->name = 'assaigned_draughtsman';
$fieldInstance->label = 'LBL_ASSAIGNED_DRAUGHTSMAN';
$fieldInstance->table = 'vtiger_blockplan';
$fieldInstance->column = 'assaigned_draughtsman';
$fieldInstance->columntype = 'varchar(100)';
$fieldInstance->uitype = 15;
...
$fieldInstance = Vtiger_Field::getInstance("LBL_ASSAIGNED_TECHNICAL_OFFICER", $moduleInstance);
        if ($fieldInstance === false) {
$fieldInstance = new Vtiger_Field();
$fieldInstance->name = 'assigned_technical_officer';
$fieldInstance->label = 'LBL_ASSAIGNED_TECHNICAL_OFFICER';
$fieldInstance->table = 'vtiger_blockplan';
$fieldInstance->column = 'assigned_technical_officer';
$fieldInstance->columntype = 'varchar(100)';
$fieldInstance->uitype = 15;
$fieldInstance->setPicklistValues(array());
$fieldInstance->typeofdata = 'V~O';
...
$fieldInstance = Vtiger_Field::getInstance("LBL_ASSAIGNED_PLANINING_ENGINEER", $moduleInstance);
        if ($fieldInstance === false) {
$fieldInstance = new Vtiger_Field();
$fieldInstance->name = 'assigned_planing_engineer';
$fieldInstance->label = 'LBL_ASSAIGNED_PLANINING_ENGINEER';
$fieldInstance->table = 'vtiger_blockplan';
$fieldInstance->column = 'assigned_planing_engineer';
$fieldInstance->columntype = 'varchar(100)';
$fieldInstance->uitype = 15;
$fieldInstance->setPicklistValues(array());
$fieldInstance->typeofdata = 'V~O';
