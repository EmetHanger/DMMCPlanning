    ...
    <html>
        ...
        <body>
            <div class="container-fluid login-container">
                <div class="row-fluid">
                    <div class="span3">
                        <div class="logo"><img src="test/logo/dmmc-logo.png">
                            <br />
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span6">
                                        <div class="login-area">
                                            <div class="login-box alignCenter" id="loginDiv">
                                                <div class="">
                                                    <h3 class="login-header">Login to DMMC ERP</h3>
                                                </div>
                                                ...
                                                <div class="login-subscript">
                                                    <small> Powered by Emetsoft Pvt. Ltd.</small>
                                                </div>
                                            </div>
